...
namespace TCCMadeireira.Models
{
    class Produto
    {
        ...
        public Produto(int id, string nome, Fornecedor fornecedor, decimal valor, decimal quantidade, DateTime dataInfo, string obs) {
            this.Id = id;
        ...
        public Produto(string nome, Fornecedor fornecedor, decimal valor, decimal quantidade, DateTime dataInfo, string obs)
        {
            this.Nome = nome.ToUpper().Trim();
            this.obs = obs;
            this.Fornecedor = fornecedor;
